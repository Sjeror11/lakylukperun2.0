...
try:
    ...
    from src.interfaces import brokerage_simulation
    
    # Replace BrokerageInterface with SimulatedBrokerageInterface
    import src.interfaces.brokerage
    src.interfaces.brokerage.BrokerageInterface = brokerage_simulation.SimulatedBrokerageInterface
...
def main():
    ...
    """
    log.info("=============================================")
    log.info("=== Starting AI Trading System Daemon (SIMULATION MODE) ===")
    log.info("=============================================")
    log.info("Running in simulation mode with simulated market data.")
    log.info("No actual trades will be executed.")
    log.info("=============================================")
